"""
Django settings for checksalesapp_8 project.
...
ROOT_URLCONF = 'checksalesapp_8.urls'
...
WSGI_APPLICATION = 'checksalesapp_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "checksalesapp_8 API",
    "DESCRIPTION": "API documentation for checksalesapp_8 App",
    "VERSION": "v1",
}
